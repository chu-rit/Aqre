...
const PUZZLE_MAPS = [
    {
        ...
        areas: [
            {
                cells: [[0,0], [0,1], [0,2], [1,0], [1,1], [1,2]],  // 왼쪽 상단 영역
                required: 'J'
            },
            {
                cells: [[0,3], [0,4], [0,5], [1,3], [1,4], [1,5]],  // 오른쪽 상단 영역
                required: 1
            },
            {
                cells: [[2,0], [2,1], [2,2], [3,0], [3,1], [3,2]],  // 왼쪽 중단 영역
                required: 1
            },
            {
                cells: [[2,3], [2,4], [2,5], [3,3], [3,4], [3,5]],  // 오른쪽 중단 영역
                required: 2
            },
            {
                cells: [[4,0], [4,1], [4,2], [5,0], [5,1], [5,2]],  // 왼쪽 하단 영역
                required: 2
            },
            {
                cells: [[4,3], [4,4], [4,5], [5,3], [5,4], [5,5]],  // 오른쪽 하단 영역
                required: 1
            }
        ],
        initialState: [
